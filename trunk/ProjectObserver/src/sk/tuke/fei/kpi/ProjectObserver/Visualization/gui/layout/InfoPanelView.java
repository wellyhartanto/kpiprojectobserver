...
public class InfoPanelView extends JPanel implements InfoPanelDisplay {
	...
	if (object instanceof Application) {
	    ...
	    JLabel classesNumber = new JLabel(bundle.getString("info.numberofclasses"));
	    JLabel interfacesNumber = new JLabel(bundle.getString("info.numberofinterfaces"));
	    JLabel packagesNumber = new JLabel(bundle.getString("info.numberofpackages"));
	    JLabel enumsNumber = new JLabel(bundle.getString("info.numberofenums"));
	    add(packagesNumber);
	...
	if (object instanceof Class) {
	    ...
	    JLabel fieldsNumber = new JLabel(bundle.getString("info.numberoffields"));
	    JLabel methodsNumber = new JLabel(bundle.getString("info.numberofmethods"));
	    JLabel classesNumber = new JLabel(bundle.getString("info.numberofclasses"));
	    JLabel enumsNumber = new JLabel(bundle.getString("info.numberofenums"));
	    add(classesNumber);
	...
	if (object instanceof Method) {
	    ...
	    JLabel exceptionsNumber = new JLabel(bundle.getString("info.numberofexceptions"));
	    JLabel paramsNumber = new JLabel(bundle.getString("info.numberofparams"));
