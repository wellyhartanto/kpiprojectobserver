...
public class TypeElement extends Element implements Alignable {
	...
	public boolean matches(Object object, AlignStrategy alignStrategy) {
		...
		if (object instanceof sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.TypeElement) {
			sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.TypeElement element = (sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.TypeElement) object;
