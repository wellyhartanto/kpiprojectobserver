...
public class Package extends Element implements Serializable, Alignable {
	...
	public boolean matches(Object object, AlignStrategy alignStrategy) {
		...
		if (object instanceof sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.Package) {
			sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.Package pack = (sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.Package) object;
