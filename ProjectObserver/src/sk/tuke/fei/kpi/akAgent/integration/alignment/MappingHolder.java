...
public class MappingHolder implements Serializable {
	 ...
	 */
	public void addPackagePair(sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.Package p1,
			sk.tuke.fei.kpi.akAgent.integration.metamodel.java.Package p2){
	 ...
	 */
	public void addClassPair(sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.Class c1,
			sk.tuke.fei.kpi.akAgent.integration.metamodel.java.Class c2){
	 ...
	 */
	public void addInterfacePair(sk.tuke.fei.kpi.akAgent.integration.metamodel.uml.classDiagram.Interface i1,
			sk.tuke.fei.kpi.akAgent.integration.metamodel.java.Interface i2){
